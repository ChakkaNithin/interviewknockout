...
export const mockPricing = [
  ...
  },
  {
    ...
    features: ['Everything in Pro', 'JobSpy Integration (LinkedIn/Indeed/Naukri)', 'AI Interview Prep', '1-on-1 Expert Review', 'LinkedIn Profile Optimizer', 'Career Coaching Session', '24/7 Premium Support'],
    cta: 'Go Premium',
    highlighted: false,
  },
];
