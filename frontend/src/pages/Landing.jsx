        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl lg:text-6xl font-extrabold text-slate-900 leading-[1.05] tracking-tight mb-5">
              Land more interviews with <span className="relative inline-block"><span className="relative z-10">InterviewKnockout's</span><span className="absolute bottom-1 left-0 w-full h-3 bg-[#FF6B47]/30 -z-0"></span></span> Resume Builder
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-6">
              All InterviewKnockout templates are tested with top Applicant Tracking Systems (ATS) to guarantee full compatibility. Clean layouts, readable fonts, and standard section titles — nothing gets lost.
            </p>
      ...
      <section className="py-20 bg-white" id="reviews">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-600">Join millions of job seekers who've built standout resumes with InterviewKnockout.</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#0F3D2E] via-[#14543F] to-[#0F3D2E] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Join 15M+ professionals who've built standout resumes with InterviewKnockout.
          </p>
