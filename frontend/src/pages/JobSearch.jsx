...
const plans = [
  {
    ...
    features: ['Full ATS Score Report', 'Book your 1-1 expert call', 'Expert Resume Rewrite', 'JD Tailoring for 1 Job Description', '15–20 Curated Job Matches', 'Direct Application Links', '24–48 hr Delivery', 'Priority Support'],
    cta: 'Get Pro',
    highlighted: false,
    badge: 'Limited Offer',
  },
  {
    ...
    features: ['Everything in Pro', 'Book your 1-1 expert call', '30–40 Curated Job Matches', 'Recruiter Contact Details', 'Company Deep-Dive Research', 'Priority 24hr Delivery', 'Direct Recruiter Outreach Tips', 'Dedicated Support'],
    cta: 'Get Premium',
    highlighted: true,
    badge: 'Best Value',
  },
